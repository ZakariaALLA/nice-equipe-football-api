package com.francefootball.niceequipefootballapi.metier.constants;

public class ErrorMessages {
    public static final String AUCUNE_EQUIPE_TROUVEE = "Aucune équipe trouvée";
    public static final String POSITION_INVALIDE = "Position de joueur est invalide";
